    ...
    <section className="mb-16">
      <div className="group relative w-full bg-[#B05B27]/90 border border-[#d4c38d] p-6 lg:p-12 transition-all duration-700 hover:shadow-[0_20px_60px_-15px_rgba(176,91,39,0.5)] flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
        ...
        <div className="w-full lg:w-[62%] aspect-[4/3] md:aspect-video overflow-hidden relative shadow-inner">
          ...
          <img 
            src="https://images.unsplash.com/photo-1605901309584-818e25960b8f?auto=format&fit=crop&q=80&w=2500" 
            alt="Hero Game" 
          ...
          <div className="absolute bottom-6 left-6 z-20 flex gap-3">
            ...
            <span className="bg-[#1a241b]/60 backdrop-blur-md border border-[#f7ebc6] text-[#f7ebc6] text-sm font-bold px-4 py-1.5 shadow-md">REVIEW</span>
          </div>
        </div>
        ...
        <div className="w-full lg:w-[38%] flex flex-col justify-center py-4 lg:py-0">
          ...
          <Link href="/article/featured" className="self-start px-10 py-4 bg-[#f7ebc6] font-bold text-lg text-[#B05B27] hover:bg-white hover:shadow-[0_0_20px_rgba(247,235,198,0.4)] transition-all duration-300">
            READ REVIEW
          </Link>
        </div>
      </div>
